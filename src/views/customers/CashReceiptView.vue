              ...
              >
                <v-form ref="form" v-model="valid" lazy-validation>
                  ...
                  >
                    <v-row class="px-6">
                      <v-col sm="6" cols="12" class="pb-0">
                        <v-row style="background:#F8F8F9" class="pa-4">
                          <v-col sm="7" cols="12" class="pb-0">
                            <label class="label mb-0  font_14">{{
                              $t("customer")
                            }}</label>
                            <h3 class="text-bold py-1">Customer</h3>
                            <label class="label mb-0 grey--text font_14">{{
                              $t("payment_reference_no")
                            }}</label>
                            <h3 class="text-bold py-1">PMT260671010101</h3>
                            <label class="label mb-0 grey--text font_14">{{
                              $t("customer_reference_no")
                            }}</label>
                            <h3 class="text-bold py-1">PMT260671010101</h3>
                          </v-col>
                          <v-col sm="5" cols="12" class="pb-0">
                            ...
                            <label
                              class="label grey--text font_14 text-capitalize"
                              >QR Code (EMV)</label
                            ><br />
                            <v-img
                              class="img_center"
                          ...
                          <v-col sm="12" cols="12" class="py-0">
                            ...
                            ><br />
                            <a class="font_12" href="#"
                              >Invoice.banhji.com/view/6d978c98-5cfa-4bb8-b746-171c08d1e254</a
                            >
                          </v-col>
                        </v-row>
                        <v-row class="mt-3">
                          <v-col sm="6" cols="12">
                            ...
                            <h4 class="text-bold py-2">
                              This will appear on the deposit form
                            </h4>
                          </v-col>
                          <v-col sm="6" cols="12">
                            <label>{{ $t("message_for_journal") }}</label>
                            <h4 class="text-bold py-2">
                              This will appear in journal for deposit
                            </h4>
                          </v-col>
                        </v-row>
                      </v-col>
                      <v-col sm="6" cosl="12">
                        <v-card
                          color="primary"
                          class="pa-2 mb-6 text-bold rounded-1"
                        >
                          <p class="text white--text text-uppercase">
                            {{ $t("amount_receipt") }}
                          </p>
                          <p
                            class="number white--text mb-0 text-bold text-right text-h4"
                          >
                            1,000.00
                          </p>
                        </v-card>
                        <v-row>
                          <v-col sm="6" cols="12" class="pr-0">
                            <label
                              class="label lb_bold mb-2 text-bold text-capitalize"
                              >{{ $t("payment_code") }}</label
                            >
                            <h4 class="secondary pa-3 white--text">
                              PMT260671010101
                            </h4>
                            <label
                              class="label lb_bold mb-2 text-bold text-capitalize"
                            ...
                            <label
                              ...
                              >{{ $t("account") }}</label
                            >
                            <h4 class="third pa-3 white--text">
                              Payment in Transit
                            </h4>
                          </v-col>
                          <v-col sm="6" cols="12">
                            <label
                              class="label mb-2 lb_bold text-bold text-uppercase"
                              >{{ $t("receipt_source") }}</label
                            >
                  ...
                  <div class="function_footer mt-0 py-2">
                    ...
                    <p class="float-left  grey--text py-3 pl-10 mb-0">
                      {{ $t("standard_cash_receipt") }}
                    </p>
