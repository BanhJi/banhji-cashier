        ...
        <v-list dense class="pa-0">
            ...
            >
              <div class="mb-0">
                <img
                  ...
                  alt="BanhJi Logo"
                />
                <p class="sub_type mb-3">{{ businessType == 'Supply' ? $t('supply_business') :businessType == 'Marketing' ? $t('marketing_business') : $t('service_business') }}</p>
              </div>
          ...
          <div class="block_menu">
            <template v-for="item in items">
              <div v-if="(item.menuTex == 'services'&& businessType == 'Marketing')||(item.menuTex == 'services'&& businessType == 'Supply') " :key="item.id" >
        ...
        <template v-slot:append>
          ...
          >
            ...
            <div class="px-4 py-1">
              ...
              <p class="mb-0 niradei_light font_12 mt-1 pl-2">
                {{ $t("banhji_term") }}
              </p>
    ...
    >
      ...
      <span class="hidden-lg-and-up">
        <a href="\" style="margin-top: 15px;">
          ...
          />
          <p
            style="color: #828282; margin-left: 16px; margin-top: -14px;"
            class="mb-2"
          >
      ...
      <!-- <h1  v-if="this.$route.meta.mainMenu && this.$route.meta.mainMenu == 'overview' " class="ml-2 hidden-sm-and-down primary--text">
...
export default {
  ...
  methods: {
    ...
    miniSideInFunction() {
      let pathURL = window.location.pathname;
      window.console.log("pathURL", pathURL);
      if(pathURL == "/en" || pathURL =="/kh" || pathURL == "/en/" || pathURL =="/kh/"){
      ...
      if (
        ...
        pathURL == "/en/payroll" ||
        pathURL == "/kh/payroll" ||
        pathURL == "/en/services_projects" ||
        pathURL == "/kh/services_projects" ||
        pathURL == "/en/working_capital" ||
        pathURL == "/kh/working_capital" ||
    ...
    writeToCookie() {
      ...
      let token = jwt.sign(cookie, process.env.VUE_APP_JWT_SESCRET, {
        expiresIn: 86400,
      });
      // document.cookie =
      //     "banhji-token=" +
      ...
      let domain = ".banhji.com";
      document.cookie =
        name + "=" + token + expires + ";domain=" + domain + "; path=/";
    },
    onChanged() {
      this.writeToCookie();
      //reload
    ...
    async loadInstitutes() {
      ...
      new Promise((resolve) => {
        setTimeout(() => {
          resolve("resolved");
          instituteHandler
            .getCompany(this.mInstitute.creator)
            .then(async (res) => {
              res.forEach((i) => {
